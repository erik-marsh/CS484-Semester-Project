...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_SphereFunctions p_SphereFunctions;
        ...
        public static SteamVR_Input_ActionSet_SphereFunctions SphereFunctions
        {
            get
            {
                return SteamVR_Actions.p_SphereFunctions.GetCopy<SteamVR_Input_ActionSet_SphereFunctions>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_SphereFunctions = ((SteamVR_Input_ActionSet_SphereFunctions)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_SphereFunctions>("/actions/SphereFunctions")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.SphereFunctions};
        }
    }
}
